...
class MessageCommentPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _MessageCommentPageState();
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              Text(mList[index].username+"评论了",style: TextStyle(color: Colors.grey),),
    ...
    return InkWell(
      ...
      child: Container(
          ...
          child: Row(
            children: <Widget>[
              new Container(
                child: FadeInImage.assetNetwork(placeholder:Constant.ASSETS_IMG + 'img_default.png' ,
